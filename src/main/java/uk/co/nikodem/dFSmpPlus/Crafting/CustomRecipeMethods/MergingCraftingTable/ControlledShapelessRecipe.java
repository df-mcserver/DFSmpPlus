...
public class ControlledShapelessRecipe {
    ...
    private Function<ControlledShapelessRecipe, ItemStack> transform;

    public ControlledShapelessRecipe(CustomItemRepresentation[] ingredients, ItemStack result, Function<ControlledShapelessRecipe, ItemStack> transformResult) {
    ...
    public Function<ControlledShapelessRecipe, ItemStack> getTransformer() {
