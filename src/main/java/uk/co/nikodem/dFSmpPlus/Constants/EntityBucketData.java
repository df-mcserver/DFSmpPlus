...
public class EntityBucketData {
    ...
    public static final Map<EntityType, Material> EntityEggIndex = Map.<EntityType, Material>ofEntries(
            ...
            Map.entry(EntityType.PARCHED, Material.PARCHED_SPAWN_EGG),
            ...
            Map.entry(EntityType.CAMEL_HUSK, Material.CAMEL_HUSK_SPAWN_EGG),
            ...
            Map.entry(EntityType.COPPER_GOLEM, Material.COPPER_GOLEM_SPAWN_EGG),
