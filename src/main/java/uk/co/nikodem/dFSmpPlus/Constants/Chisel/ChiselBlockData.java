...
public class ChiselBlockData {
    ...
    public static void createChiselBlockData() {
        ...
        new ChiselBlockDataBuilder(Material.BLACK_WOOL).setReplacement(Material.WHITE_WOOL).setDrop(Material.BLACK_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.BLUE_WOOL).setReplacement(Material.WHITE_WOOL).setDrop(Material.BLUE_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.BROWN_WOOL).setReplacement(Material.WHITE_WOOL).setDrop(Material.BROWN_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.CYAN_WOOL).setReplacement(Material.WHITE_WOOL).setDrop(Material.CYAN_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.GRAY_WOOL).setReplacement(Material.WHITE_WOOL).setDrop(Material.GRAY_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.GREEN_WOOL).setReplacement(Material.WHITE_WOOL).setDrop(Material.GREEN_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.LIGHT_GRAY_WOOL).setReplacement(Material.WHITE_WOOL).setDrop(Material.LIGHT_GRAY_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.LIGHT_BLUE_WOOL).setReplacement(Material.WHITE_WOOL).setDrop(Material.LIGHT_BLUE_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.LIME_WOOL).setReplacement(Material.WHITE_WOOL).setDrop(Material.LIME_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.MAGENTA_WOOL).setReplacement(Material.WHITE_WOOL).setDrop(Material.MAGENTA_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.ORANGE_WOOL).setReplacement(Material.WHITE_WOOL).setDrop(Material.ORANGE_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.PINK_WOOL).setReplacement(Material.WHITE_WOOL).setDrop(Material.PINK_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.PURPLE_WOOL).setReplacement(Material.WHITE_WOOL).setDrop(Material.PURPLE_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.RED_WOOL).setReplacement(Material.WHITE_WOOL).setDrop(Material.RED_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.YELLOW_WOOL).setReplacement(Material.WHITE_WOOL).setDrop(Material.YELLOW_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();

        new ChiselBlockDataBuilder(Material.BLACK_CARPET).setReplacement(Material.WHITE_CARPET).setDrop(Material.BLACK_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.BLUE_CARPET).setReplacement(Material.WHITE_CARPET).setDrop(Material.BLUE_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.BROWN_CARPET).setReplacement(Material.WHITE_CARPET).setDrop(Material.BROWN_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.CYAN_CARPET).setReplacement(Material.WHITE_CARPET).setDrop(Material.CYAN_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.GRAY_CARPET).setReplacement(Material.WHITE_CARPET).setDrop(Material.GRAY_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.GREEN_CARPET).setReplacement(Material.WHITE_CARPET).setDrop(Material.GREEN_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.LIGHT_GRAY_CARPET).setReplacement(Material.WHITE_CARPET).setDrop(Material.LIGHT_GRAY_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.LIGHT_BLUE_CARPET).setReplacement(Material.WHITE_CARPET).setDrop(Material.LIGHT_BLUE_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.LIME_CARPET).setReplacement(Material.WHITE_CARPET).setDrop(Material.LIME_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.MAGENTA_CARPET).setReplacement(Material.WHITE_CARPET).setDrop(Material.MAGENTA_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.ORANGE_CARPET).setReplacement(Material.WHITE_CARPET).setDrop(Material.ORANGE_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.PINK_CARPET).setReplacement(Material.WHITE_CARPET).setDrop(Material.PINK_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.PURPLE_CARPET).setReplacement(Material.WHITE_CARPET).setDrop(Material.PURPLE_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.RED_CARPET).setReplacement(Material.WHITE_CARPET).setDrop(Material.RED_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        new ChiselBlockDataBuilder(Material.YELLOW_CARPET).setReplacement(Material.WHITE_CARPET).setDrop(Material.YELLOW_DYE).setSpeedMultiplayer(0.5f).setSoundData(Sounds.WoolChisel).create();
        ...
        new ChiselBlockDataBuilder(Material.COBWEB).setReplacement(Material.STRING).setDrop(Material.SLIME_BALL, 1).setSpeedMultiplayer(0.5f).setSoundData(Sounds.CobwebBreak).create();

        new ChiselBlockDataBuilder(Material.OAK_LEAVES).setReplacement(Material.AIR).setDrop(Material.OAK_SAPLING, 1).setSpeedMultiplayer(0.1f).setSoundData(Sounds.WoodCrash).create();
        new ChiselBlockDataBuilder(Material.BIRCH_LEAVES).setReplacement(Material.AIR).setDrop(Material.BIRCH_SAPLING, 1).setSpeedMultiplayer(0.1f).setSoundData(Sounds.WoodCrash).create();
        new ChiselBlockDataBuilder(Material.SPRUCE_LEAVES).setReplacement(Material.AIR).setDrop(Material.SPRUCE_SAPLING, 1).setSpeedMultiplayer(0.1f).setSoundData(Sounds.WoodCrash).create();
        new ChiselBlockDataBuilder(Material.JUNGLE_LEAVES).setReplacement(Material.AIR).setDrop(Material.JUNGLE_LEAVES, 1).setSpeedMultiplayer(0.1f).setSoundData(Sounds.WoodCrash).create();
        new ChiselBlockDataBuilder(Material.ACACIA_LEAVES).setReplacement(Material.AIR).setDrop(Material.ACACIA_SAPLING, 1).setSpeedMultiplayer(0.1f).setSoundData(Sounds.WoodCrash).create();
        new ChiselBlockDataBuilder(Material.DARK_OAK_LEAVES).setReplacement(Material.AIR).setDrop(Material.DARK_OAK_LEAVES, 1).setSpeedMultiplayer(0.1f).setSoundData(Sounds.WoodCrash).create();
        new ChiselBlockDataBuilder(Material.MANGROVE_LEAVES).setReplacement(Material.AIR).setDrop(Material.MANGROVE_PROPAGULE, 1).setSpeedMultiplayer(0.1f).setSoundData(Sounds.WoodCrash).create();
        new ChiselBlockDataBuilder(Material.CHERRY_LEAVES).setReplacement(Material.AIR).setDrop(Material.CHERRY_SAPLING, 1).setSpeedMultiplayer(0.1f).setSoundData(Sounds.WoodCrash).create();
        new ChiselBlockDataBuilder(Material.PALE_OAK_LEAVES).setReplacement(Material.AIR).setDrop(Material.PALE_OAK_LEAVES, 1).setSpeedMultiplayer(0.1f).setSoundData(Sounds.WoodCrash).create();
