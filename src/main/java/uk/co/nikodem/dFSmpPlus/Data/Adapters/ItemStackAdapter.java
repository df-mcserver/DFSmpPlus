...
public class ItemStackAdapter implements JsonSerializer<ItemStack>, JsonDeserializer<ItemStack> {
    ...
    public ItemStack deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        Map<String, Object> map = DFSmpPlus.gson.fromJson(json, TypeToken.get(Map.class).getType());
        map.putIfAbsent("v", Bukkit.getUnsafe().getDataVersion());

        if(map.containsKey("meta")) {
            Map<String, Object> meta = (Map<String, Object>) map.get("meta");
            ConfigurationSerializable deserializedMeta = context.deserialize(DFSmpPlus.gson.toJsonTree(meta), ConfigurationSerializable.class);
            map.remove("meta");
    ...
    public JsonElement serialize(ItemStack src, Type typeOfSrc, JsonSerializationContext context) {
        ...
        return DFSmpPlus.gson.toJsonTree(map);
    }
}
