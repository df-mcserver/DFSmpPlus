...
public class DFMaterial {
    ...
    public static DFMaterial FiridiumHelmet = new Builder(Material.IRON_HELMET, "firidium_helmet", 1)
...
//            .create();
//
//    public static DFMaterial ImpureTanzanite = new Builder(Material.FIREWORK_STAR, "impure_tanzanite", 1)
//            .setDisplayName("Impure Tanzanite")
//            .create();
//
//    public static DFMaterial TanzaniteOre = new Builder(Material.END_STONE, "tanzanite_ore", 1)
//            .setDisplayName("Tanzanite Ore")
//            .create();
//
//    public static DFMaterial Uranium = new Builder(Material.FIREWORK_STAR, "uranium", 1)
//            .setDisplayName("Uranium")
//            .create();
//
//    public static DFMaterial ImpureUranium = new Builder(Material.FIREWORK_STAR, "impure_uranium", 1)
//            .setDisplayName("Impure Uranium")
//            .create();
//
//    public static DFMaterial ContaminatedMud = new Builder(Material.MUD, "contaminated_mud", 1)
...
//            .create();
    ...
    public static DFMaterial ObsidianChestplate = new Builder(Material.NETHERITE_CHESTPLATE, "obsidian_chestplate", 1)
    ...
    public static DFMaterial ObsidianLeggings = new Builder(Material.NETHERITE_LEGGINGS, "obsidian_leggings", 1)
    ...
    public static DFMaterial ObsidianBoots = new Builder(Material.NETHERITE_BOOTS, "obsidian_boots", 1)
    ...
    public static DFMaterial WarpedWart = new Builder(Material.NETHER_WART, "warped_wart", 1)
            .setDisplayName("Warped Wart")
            .addMeta(new PreventPlacingMeta())
            .create();

    public static DFMaterial SculkHelmet = new Builder(Material.DIAMOND_HELMET, "sculk_helmet", 1)
    ...
    public static DFMaterial SculkChestplate = new Builder(Material.DIAMOND_CHESTPLATE, "sculk_chestplate", 1)
    ...
    public static DFMaterial SculkLeggings = new Builder(Material.DIAMOND_LEGGINGS, "sculk_leggings", 1)
    ...
    public static DFMaterial SculkBoots = new Builder(Material.DIAMOND_BOOTS, "sculk_boots", 1)
    ...
    public static DFMaterial SculkFragment = new Builder(Material.ECHO_SHARD, "sculk_fragment", 1)
            .setDisplayName("Sculk Fragment")
            .create();

    public static DFMaterial VampireSword = new Builder(Material.WOODEN_SWORD, "vampire_sword", 1)
    ...
    public static DFMaterial CalciteChestplate = new Builder(Material.CHAINMAIL_CHESTPLATE, "calcite_chestplate", 1)
    ...
    public static DFMaterial CalciteLeggings = new Builder(Material.CHAINMAIL_LEGGINGS, "calcite_leggings", 1)
    ...
    public static DFMaterial CalciteBoots = new Builder(Material.CHAINMAIL_BOOTS, "calcite_boots", 1)
    ...
    public static DFMaterial CustomTotem = new Builder(Material.TOTEM_OF_UNDYING, "custom_totem", 1)
    ...
    public static DFMaterial FloralHelmet = new Builder(Material.IRON_HELMET, "floral_helmet", 1)
    ...
    public static DFMaterial FloralChestplate = new Builder(Material.IRON_CHESTPLATE, "floral_chestplate", 1)
    ...
    public static DFMaterial FloralLeggings = new Builder(Material.IRON_LEGGINGS, "floral_leggings", 1)
    ...
    public static DFMaterial FloralBoots = new Builder(Material.IRON_BOOTS, "floral_boots", 1)
    ...
    public static class Builder {
        ...
        public Builder(Material base, String namedId, int version) {
            this.base = base;
            this.namedId = namedId;
            this.version = version;
        }
